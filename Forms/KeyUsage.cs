...
namespace DataBaseStudents
{
    public partial class KeyUsage : Form
    {
        ...
        [DllImport(@"D:\Dev\UnityDev\Proxy\Assets\Plugins\x86\NativeRun.dll", EntryPoint = "_CountLettersInString@4")]
        private static extern int
CountLettersInString([MarshalAs(UnmanagedType.LPWStr)]string str);
        private void button1_Click(object sender, EventArgs e)
        {
            int len = CountLettersInString("Hello, world!");

            this.Text = len.ToString();
        }
    }
}
